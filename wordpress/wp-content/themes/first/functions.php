...
if ( ! function_exists( 'first_setup' ) ) :
	...
	function first_setup() {
		...
		register_nav_menus( array(
			'company' => esc_html__( 'Company', 'first' ),
			'navmenu' => esc_html__( 'Navmenu', 'first' )
			
		) );
		register_nav_menus( array(
			'follow us' => esc_html__( 'Follow us', 'first' )
			
		) );
		register_nav_menus( array(
			'more about bion' => esc_html__( 'More about bion', 'first' )
...
function first_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'first_content_width', 640 );
}
add_action( 'after_setup_theme', 'first_content_width', 0 );
...
function first_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'first' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'first' ),
...
function first_scripts() {
	...
	wp_enqueue_script( 'first-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'first-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
